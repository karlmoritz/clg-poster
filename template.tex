%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Jacobs Landscape Poster (Oxford)
% LaTeX Template
% Version 1.1 (14/07/13)
%
% Created by:
...
%
% Oxford theme and further modifications by:
...
\setlength{\twocolwid}{0.476\paperwidth} % Width of two columns
\setlength{\threecolwid}{0.722\paperwidth} % Width of three columns
  ...
  \begin{column}{\sepwid}\end{column} % Empty spacer column
    ...
    \begin{column}{\onecolwid} % The third column
      ...
      \begin{block}{Acknowledgements}
        ...
        \small{\rmfamily{Nam mollis tristique neque eu nisi sed convallis.
            Aenean id neque dolor. Pellentesque habitant morbi tristique
